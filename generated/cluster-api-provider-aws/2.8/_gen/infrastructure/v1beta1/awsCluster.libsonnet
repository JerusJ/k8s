{
  ...
  spec: {
    ...
    controlPlaneLoadBalancer: {
      ...
      '#withHealthCheckProtocol':: d.fn(help='"HealthCheckProtocol sets the protocol type for classic ELB health check target\\ndefault value is ClassicELBProtocolSSL"', args=[d.arg(name='healthCheckProtocol', type=d.T.string)]),
