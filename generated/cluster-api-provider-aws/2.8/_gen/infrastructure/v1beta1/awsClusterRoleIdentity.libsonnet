{
  ...
  '#':: d.pkg(name='awsClusterRoleIdentity', url='', help='"AWSClusterRoleIdentity is the Schema for the awsclusterroleidentities API\\nIt is used to assume a role using the provided sourceRef."'),
  ...
  spec: {
    '#allowedNamespaces':: d.obj(help='"AllowedNamespaces is used to identify which namespaces are allowed to use the identity from.\\nNamespaces can be selected either using an array of namespaces or with label selector.\\nAn empty allowedNamespaces object indicates that AWSClusters can use this identity from any namespace.\\nIf this object is nil, no namespaces will be allowed (default behaviour, if this field is not provided)\\nA namespace should be either in the NamespaceList or match with Selector to use the identity."'),
    allowedNamespaces: {
      '#selector':: d.obj(help='"An empty selector indicates that AWSClusters cannot use this\\nAWSClusterIdentity from any namespace."'),
      selector: {
    ...
    '#sourceIdentityRef':: d.obj(help='"SourceIdentityRef is a reference to another identity which will be chained to do\\nrole assumption. All identity types are accepted."'),
    sourceIdentityRef: {
    ...
    '#withPolicyARNs':: d.fn(help='"The Amazon Resource Names (ARNs) of the IAM managed policies that you want\\nto use as managed session policies.\\nThe policies must exist in the same account as the role."', args=[d.arg(name='policyARNs', type=d.T.array)]),
    withPolicyARNs(policyARNs): { spec+: { policyARNs: if std.isArray(v=policyARNs) then policyARNs else [policyARNs] } },
    '#withPolicyARNsMixin':: d.fn(help='"The Amazon Resource Names (ARNs) of the IAM managed policies that you want\\nto use as managed session policies.\\nThe policies must exist in the same account as the role."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='policyARNs', type=d.T.array)]),
