{
  ...
  spec: {
    ...
    additionalSecurityGroups: {
      ...
      '#withArn':: d.fn(help='"ARN of resource.\\nDeprecated: This field has no function and is going to be removed in the next release."', args=[d.arg(name='arn', type=d.T.string)]),
      withArn(arn): { arn: arn },
    ...
    '#withFailureDomain':: d.fn(help='"FailureDomain is the failure domain unique identifier this Machine should be attached to, as defined in Cluster API.\\nFor this infrastructure provider, the ID is equivalent to an AWS Availability Zone.\\nIf multiple subnets are matched for the availability zone, the first one returned is picked."', args=[d.arg(name='failureDomain', type=d.T.string)]),
