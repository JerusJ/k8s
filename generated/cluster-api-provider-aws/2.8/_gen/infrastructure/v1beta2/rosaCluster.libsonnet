{
  ...
  '#':: d.pkg(name='rosaCluster', url='', help='"ROSACluster is the Schema for the ROSAClusters API."'),
  ...
  '#new':: d.fn(help='new returns an instance of ROSACluster', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'infrastructure.cluster.x-k8s.io/v1beta2',
    kind: 'ROSACluster',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ROSAClusterSpec defines the desired state of ROSACluster."'),
  spec: {
