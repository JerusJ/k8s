{
  ...
  spec: {
    '#template':: d.obj(help='"AWSClusterTemplateResource defines the desired state of AWSClusterTemplateResource."'),
    template: {
      ...
      spec: {
        ...
        controlPlaneLoadBalancer: {
          ...
          healthCheck: {
            '#withIntervalSeconds':: d.fn(help='"The approximate amount of time, in seconds, between health checks of an individual\\ntarget."', args=[d.arg(name='intervalSeconds', type=d.T.integer)]),
            withIntervalSeconds(intervalSeconds): { spec+: { template+: { spec+: { controlPlaneLoadBalancer+: { healthCheck+: { intervalSeconds: intervalSeconds } } } } } },
            '#withThresholdCount':: d.fn(help='"The number of consecutive health check successes required before considering\\na target healthy."', args=[d.arg(name='thresholdCount', type=d.T.integer)]),
            withThresholdCount(thresholdCount): { spec+: { template+: { spec+: { controlPlaneLoadBalancer+: { healthCheck+: { thresholdCount: thresholdCount } } } } } },
            '#withTimeoutSeconds':: d.fn(help='"The amount of time, in seconds, during which no response from a target means\\na failed health check."', args=[d.arg(name='timeoutSeconds', type=d.T.integer)]),
            withTimeoutSeconds(timeoutSeconds): { spec+: { template+: { spec+: { controlPlaneLoadBalancer+: { healthCheck+: { timeoutSeconds: timeoutSeconds } } } } } },
            '#withUnhealthyThresholdCount':: d.fn(help='"The number of consecutive health check failures required before considering\\na target unhealthy."', args=[d.arg(name='unhealthyThresholdCount', type=d.T.integer)]),
            withUnhealthyThresholdCount(unhealthyThresholdCount): { spec+: { template+: { spec+: { controlPlaneLoadBalancer+: { healthCheck+: { unhealthyThresholdCount: unhealthyThresholdCount } } } } } },
          },
          ...
          withAdditionalListeners(additionalListeners): { spec+: { template+: { spec+: { controlPlaneLoadBalancer+: { additionalListeners: if std.isArray(v=additionalListeners) then additionalListeners else [additionalListeners] } } } } },
          ...
          withAdditionalListenersMixin(additionalListeners): { spec+: { template+: { spec+: { controlPlaneLoadBalancer+: { additionalListeners+: if std.isArray(v=additionalListeners) then additionalListeners else [additionalListeners] } } } } },
          ...
          withDisableHostsRewrite(disableHostsRewrite): { spec+: { template+: { spec+: { controlPlaneLoadBalancer+: { disableHostsRewrite: disableHostsRewrite } } } } },
          ...
          withIngressRules(ingressRules): { spec+: { template+: { spec+: { controlPlaneLoadBalancer+: { ingressRules: if std.isArray(v=ingressRules) then ingressRules else [ingressRules] } } } } },
          ...
          withIngressRulesMixin(ingressRules): { spec+: { template+: { spec+: { controlPlaneLoadBalancer+: { ingressRules+: if std.isArray(v=ingressRules) then ingressRules else [ingressRules] } } } } },
          ...
          withLoadBalancerType(loadBalancerType): { spec+: { template+: { spec+: { controlPlaneLoadBalancer+: { loadBalancerType: loadBalancerType } } } } },
          ...
          withPreserveClientIP(preserveClientIP): { spec+: { template+: { spec+: { controlPlaneLoadBalancer+: { preserveClientIP: preserveClientIP } } } } },
        ...
        network: {
          ...
          vpc: {
            ...
            elasticIpPool: {
              ...
              withPublicIpv4Pool(publicIpv4Pool): { spec+: { template+: { spec+: { network+: { vpc+: { elasticIpPool+: { publicIpv4Pool: publicIpv4Pool } } } } } } },
              ...
              withPublicIpv4PoolFallbackOrder(publicIpv4PoolFallbackOrder): { spec+: { template+: { spec+: { network+: { vpc+: { elasticIpPool+: { publicIpv4PoolFallbackOrder: publicIpv4PoolFallbackOrder } } } } } } },
            },
            ...
            ipamPool: {
              ...
              withId(id): { spec+: { template+: { spec+: { network+: { vpc+: { ipamPool+: { id: id } } } } } } },
              ...
              withName(name): { spec+: { template+: { spec+: { network+: { vpc+: { ipamPool+: { name: name } } } } } } },
              ...
              withNetmaskLength(netmaskLength): { spec+: { template+: { spec+: { network+: { vpc+: { ipamPool+: { netmaskLength: netmaskLength } } } } } } },
            },
            ...
            ipv6: {
              ...
              ipamPool: {
                '#withId':: d.fn(help='"ID is the ID of the IPAM pool this provider should use to create VPC."', args=[d.arg(name='id', type=d.T.string)]),
                withId(id): { spec+: { template+: { spec+: { network+: { vpc+: { ipv6+: { ipamPool+: { id: id } } } } } } } },
                '#withName':: d.fn(help='"Name is the name of the IPAM pool this provider should use to create VPC."', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { spec+: { template+: { spec+: { network+: { vpc+: { ipv6+: { ipamPool+: { name: name } } } } } } } },
                '#withNetmaskLength':: d.fn(help='"The netmask length of the IPv4 CIDR you want to allocate to VPC from\\nan Amazon VPC IP Address Manager (IPAM) pool.\\nDefaults to /16 for IPv4 if not specified."', args=[d.arg(name='netmaskLength', type=d.T.integer)]),
                withNetmaskLength(netmaskLength): { spec+: { template+: { spec+: { network+: { vpc+: { ipv6+: { ipamPool+: { netmaskLength: netmaskLength } } } } } } } },
              },
            ...
            withCarrierGatewayId(carrierGatewayId): { spec+: { template+: { spec+: { network+: { vpc+: { carrierGatewayId: carrierGatewayId } } } } } },
            ...
            withEmptyRoutesDefaultVPCSecurityGroup(emptyRoutesDefaultVPCSecurityGroup): { spec+: { template+: { spec+: { network+: { vpc+: { emptyRoutesDefaultVPCSecurityGroup: emptyRoutesDefaultVPCSecurityGroup } } } } } },
            ...
            withPrivateDnsHostnameTypeOnLaunch(privateDnsHostnameTypeOnLaunch): { spec+: { template+: { spec+: { network+: { vpc+: { privateDnsHostnameTypeOnLaunch: privateDnsHostnameTypeOnLaunch } } } } } },
            ...
            withSecondaryCidrBlocks(secondaryCidrBlocks): { spec+: { template+: { spec+: { network+: { vpc+: { secondaryCidrBlocks: if std.isArray(v=secondaryCidrBlocks) then secondaryCidrBlocks else [secondaryCidrBlocks] } } } } } },
            ...
            withSecondaryCidrBlocksMixin(secondaryCidrBlocks): { spec+: { template+: { spec+: { network+: { vpc+: { secondaryCidrBlocks+: if std.isArray(v=secondaryCidrBlocks) then secondaryCidrBlocks else [secondaryCidrBlocks] } } } } } },
            ...
            withSubnetSchema(subnetSchema): { spec+: { template+: { spec+: { network+: { vpc+: { subnetSchema: subnetSchema } } } } } },
            '#withTags':: d.fn(help='"Tags is a collection of tags describing the resource."', args=[d.arg(name='tags', type=d.T.object)]),
          ...
          withAdditionalControlPlaneIngressRules(additionalControlPlaneIngressRules): { spec+: { template+: { spec+: { network+: { additionalControlPlaneIngressRules: if std.isArray(v=additionalControlPlaneIngressRules) then additionalControlPlaneIngressRules else [additionalControlPlaneIngressRules] } } } } },
          ...
          withAdditionalControlPlaneIngressRulesMixin(additionalControlPlaneIngressRules): { spec+: { template+: { spec+: { network+: { additionalControlPlaneIngressRules+: if std.isArray(v=additionalControlPlaneIngressRules) then additionalControlPlaneIngressRules else [additionalControlPlaneIngressRules] } } } } },
          ...
          withNodePortIngressRuleCidrBlocks(nodePortIngressRuleCidrBlocks): { spec+: { template+: { spec+: { network+: { nodePortIngressRuleCidrBlocks: if std.isArray(v=nodePortIngressRuleCidrBlocks) then nodePortIngressRuleCidrBlocks else [nodePortIngressRuleCidrBlocks] } } } } },
          ...
          withNodePortIngressRuleCidrBlocksMixin(nodePortIngressRuleCidrBlocks): { spec+: { template+: { spec+: { network+: { nodePortIngressRuleCidrBlocks+: if std.isArray(v=nodePortIngressRuleCidrBlocks) then nodePortIngressRuleCidrBlocks else [nodePortIngressRuleCidrBlocks] } } } } },
        ...
        s3Bucket: {
          ...
          withBestEffortDeleteObjects(bestEffortDeleteObjects): { spec+: { template+: { spec+: { s3Bucket+: { bestEffortDeleteObjects: bestEffortDeleteObjects } } } } },
          ...
          withPresignedURLDuration(presignedURLDuration): { spec+: { template+: { spec+: { s3Bucket+: { presignedURLDuration: presignedURLDuration } } } } },
        },
        ...
        secondaryControlPlaneLoadBalancer: {
          ...
          healthCheck: {
            '#withIntervalSeconds':: d.fn(help='"The approximate amount of time, in seconds, between health checks of an individual\\ntarget."', args=[d.arg(name='intervalSeconds', type=d.T.integer)]),
            withIntervalSeconds(intervalSeconds): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { healthCheck+: { intervalSeconds: intervalSeconds } } } } } },
            '#withThresholdCount':: d.fn(help='"The number of consecutive health check successes required before considering\\na target healthy."', args=[d.arg(name='thresholdCount', type=d.T.integer)]),
            withThresholdCount(thresholdCount): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { healthCheck+: { thresholdCount: thresholdCount } } } } } },
            '#withTimeoutSeconds':: d.fn(help='"The amount of time, in seconds, during which no response from a target means\\na failed health check."', args=[d.arg(name='timeoutSeconds', type=d.T.integer)]),
            withTimeoutSeconds(timeoutSeconds): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { healthCheck+: { timeoutSeconds: timeoutSeconds } } } } } },
            '#withUnhealthyThresholdCount':: d.fn(help='"The number of consecutive health check failures required before considering\\na target unhealthy."', args=[d.arg(name='unhealthyThresholdCount', type=d.T.integer)]),
            withUnhealthyThresholdCount(unhealthyThresholdCount): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { healthCheck+: { unhealthyThresholdCount: unhealthyThresholdCount } } } } } },
          },
          '#ingressRules':: d.obj(help='"IngressRules sets the ingress rules for the control plane load balancer."'),
          ingressRules: {
            '#withCidrBlocks':: d.fn(help='"List of CIDR blocks to allow access from. Cannot be specified with SourceSecurityGroupID."', args=[d.arg(name='cidrBlocks', type=d.T.array)]),
          ...
          '#withAdditionalListeners':: d.fn(help='"AdditionalListeners sets the additional listeners for the control plane load balancer.\\nThis is only applicable to Network Load Balancer (NLB) types for the time being."', args=[d.arg(name='additionalListeners', type=d.T.array)]),
          withAdditionalListeners(additionalListeners): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { additionalListeners: if std.isArray(v=additionalListeners) then additionalListeners else [additionalListeners] } } } } },
          '#withAdditionalListenersMixin':: d.fn(help='"AdditionalListeners sets the additional listeners for the control plane load balancer.\\nThis is only applicable to Network Load Balancer (NLB) types for the time being."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='additionalListeners', type=d.T.array)]),
          withAdditionalListenersMixin(additionalListeners): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { additionalListeners+: if std.isArray(v=additionalListeners) then additionalListeners else [additionalListeners] } } } } },
          '#withAdditionalSecurityGroups':: d.fn(help='"AdditionalSecurityGroups sets the security groups used by the load balancer. Expected to be security group IDs\\nThis is optional - if not provided new security groups will be created for the load balancer"', args=[d.arg(name='additionalSecurityGroups', type=d.T.array)]),
          withAdditionalSecurityGroups(additionalSecurityGroups): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { additionalSecurityGroups: if std.isArray(v=additionalSecurityGroups) then additionalSecurityGroups else [additionalSecurityGroups] } } } } },
          '#withAdditionalSecurityGroupsMixin':: d.fn(help='"AdditionalSecurityGroups sets the security groups used by the load balancer. Expected to be security group IDs\\nThis is optional - if not provided new security groups will be created for the load balancer"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='additionalSecurityGroups', type=d.T.array)]),
          withAdditionalSecurityGroupsMixin(additionalSecurityGroups): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { additionalSecurityGroups+: if std.isArray(v=additionalSecurityGroups) then additionalSecurityGroups else [additionalSecurityGroups] } } } } },
          '#withCrossZoneLoadBalancing':: d.fn(help='"CrossZoneLoadBalancing enables the classic ELB cross availability zone balancing.\\n\\nWith cross-zone load balancing, each load balancer node for your Classic Load Balancer\\ndistributes requests evenly across the registered instances in all enabled Availability Zones.\\nIf cross-zone load balancing is disabled, each load balancer node distributes requests evenly across\\nthe registered instances in its Availability Zone only.\\n\\nDefaults to false."', args=[d.arg(name='crossZoneLoadBalancing', type=d.T.boolean)]),
          withCrossZoneLoadBalancing(crossZoneLoadBalancing): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { crossZoneLoadBalancing: crossZoneLoadBalancing } } } } },
          '#withDisableHostsRewrite':: d.fn(help="\"DisableHostsRewrite disabled the hair pinning issue solution that adds the NLB's address as 127.0.0.1 to the hosts\\nfile of each instance. This is by default, false.\"", args=[d.arg(name='disableHostsRewrite', type=d.T.boolean)]),
          withDisableHostsRewrite(disableHostsRewrite): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { disableHostsRewrite: disableHostsRewrite } } } } },
          '#withHealthCheckProtocol':: d.fn(help='"HealthCheckProtocol sets the protocol type for ELB health check target\\ndefault value is ELBProtocolSSL"', args=[d.arg(name='healthCheckProtocol', type=d.T.string)]),
          withHealthCheckProtocol(healthCheckProtocol): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { healthCheckProtocol: healthCheckProtocol } } } } },
          '#withIngressRules':: d.fn(help='"IngressRules sets the ingress rules for the control plane load balancer."', args=[d.arg(name='ingressRules', type=d.T.array)]),
          withIngressRules(ingressRules): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { ingressRules: if std.isArray(v=ingressRules) then ingressRules else [ingressRules] } } } } },
          '#withIngressRulesMixin':: d.fn(help='"IngressRules sets the ingress rules for the control plane load balancer."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ingressRules', type=d.T.array)]),
          withIngressRulesMixin(ingressRules): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { ingressRules+: if std.isArray(v=ingressRules) then ingressRules else [ingressRules] } } } } },
          '#withLoadBalancerType':: d.fn(help='"LoadBalancerType sets the type for a load balancer. The default type is classic."', args=[d.arg(name='loadBalancerType', type=d.T.string)]),
          withLoadBalancerType(loadBalancerType): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { loadBalancerType: loadBalancerType } } } } },
          '#withName':: d.fn(help='"Name sets the name of the classic ELB load balancer. As per AWS, the name must be unique\\nwithin your set of load balancers for the region, must have a maximum of 32 characters, must\\ncontain only alphanumeric characters or hyphens, and cannot begin or end with a hyphen. Once\\nset, the value cannot be changed."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { name: name } } } } },
          '#withPreserveClientIP':: d.fn(help='"PreserveClientIP lets the user control if preservation of client ips must be retained or not.\\nIf this is enabled 6443 will be opened to 0.0.0.0/0."', args=[d.arg(name='preserveClientIP', type=d.T.boolean)]),
          withPreserveClientIP(preserveClientIP): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { preserveClientIP: preserveClientIP } } } } },
          '#withScheme':: d.fn(help='"Scheme sets the scheme of the load balancer (defaults to internet-facing)"', args=[d.arg(name='scheme', type=d.T.string)]),
          withScheme(scheme): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { scheme: scheme } } } } },
          '#withSubnets':: d.fn(help='"Subnets sets the subnets that should be applied to the control plane load balancer (defaults to discovered subnets for managed VPCs or an empty set for unmanaged VPCs)"', args=[d.arg(name='subnets', type=d.T.array)]),
          withSubnets(subnets): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { subnets: if std.isArray(v=subnets) then subnets else [subnets] } } } } },
          '#withSubnetsMixin':: d.fn(help='"Subnets sets the subnets that should be applied to the control plane load balancer (defaults to discovered subnets for managed VPCs or an empty set for unmanaged VPCs)"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subnets', type=d.T.array)]),
          withSubnetsMixin(subnets): { spec+: { template+: { spec+: { secondaryControlPlaneLoadBalancer+: { subnets+: if std.isArray(v=subnets) then subnets else [subnets] } } } } },
        },
        ...
        withPartition(partition): { spec+: { template+: { spec+: { partition: partition } } } },
