{
  ...
  '#':: d.pkg(name='awsClusterStaticIdentity', url='', help='"AWSClusterStaticIdentity is the Schema for the awsclusterstaticidentities API\\nIt represents a reference to an AWS access key ID and secret access key, stored in a secret."'),
  ...
  spec: {
    ...
    '#withSecretRef':: d.fn(help='"Reference to a secret containing the credentials. The secret should\\ncontain the following data keys:\\n AccessKeyID: AKIAIOSFODNN7EXAMPLE\\n SecretAccessKey: wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY\\n SessionToken: Optional"', args=[d.arg(name='secretRef', type=d.T.string)]),
