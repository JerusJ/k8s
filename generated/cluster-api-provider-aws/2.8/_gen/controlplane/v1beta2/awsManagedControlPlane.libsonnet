{
  ...
  spec: {
    ...
    '#withBootstrapSelfManagedAddons':: d.fn(help='"BootstrapSelfManagedAddons is used to set configuration options for\\nbare EKS cluster without EKS default networking addons\\nIf you set this value to false when creating a cluster, the default networking add-ons will not be installed"', args=[d.arg(name='bootstrapSelfManagedAddons', type=d.T.boolean)]),
    withBootstrapSelfManagedAddons(bootstrapSelfManagedAddons): { spec+: { bootstrapSelfManagedAddons: bootstrapSelfManagedAddons } },
    ...
    '#withRestrictPrivateSubnets':: d.fn(help='"RestrictPrivateSubnets indicates that the EKS control plane should only use private subnets."', args=[d.arg(name='restrictPrivateSubnets', type=d.T.boolean)]),
    withRestrictPrivateSubnets(restrictPrivateSubnets): { spec+: { restrictPrivateSubnets: restrictPrivateSubnets } },
