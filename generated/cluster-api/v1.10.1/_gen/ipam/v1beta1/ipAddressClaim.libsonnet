{
  ...
  '#':: d.pkg(name='ipAddressClaim', url='', help='"IPAddressClaim is the Schema for the ipaddressclaim API."'),
  ...
  '#new':: d.fn(help='new returns an instance of IPAddressClaim', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ipam.cluster.x-k8s.io/v1beta1',
    kind: 'IPAddressClaim',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"spec is the desired state of IPAddressClaim."'),
  spec: {
    '#poolRef':: d.obj(help='"poolRef is a reference to the pool from which an IP address should be created."'),
    poolRef: {
