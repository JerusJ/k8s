{
  ...
  spec: {
    ...
    '#selector':: d.obj(help='"selector is the label selector to match machines whose health will be exercised"'),
    selector: {
    ...
    '#withNodeStartupTimeout':: d.fn(help='"nodeStartupTimeout is the duration after which machines without a node will be considered to\\nhave failed and will be remediated."', args=[d.arg(name='nodeStartupTimeout', type=d.T.string)]),
