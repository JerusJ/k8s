{
  ...
  spec: {
    ...
    '#withMinReadySeconds':: d.fn(help='"minReadySeconds is the minimum number of seconds for which a newly created machine should be ready.\\nDefaults to 0 (machine will be considered available as soon as it is ready)"', args=[d.arg(name='minReadySeconds', type=d.T.integer)]),
    withMinReadySeconds(minReadySeconds): { spec+: { minReadySeconds: minReadySeconds } },
    '#withReplicas':: d.fn(help='"replicas is the number of desired replicas.\\nThis is a pointer to distinguish between explicit zero and unspecified.\\nDefaults to 1."', args=[d.arg(name='replicas', type=d.T.integer)]),
