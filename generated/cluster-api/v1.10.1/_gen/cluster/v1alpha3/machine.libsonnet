{
  ...
  '#spec':: d.obj(help='"spec is the desired state of Machine."'),
  spec: {
    ...
    bootstrap: {
      ...
      configRef: {
        ...
        withApiVersion(apiVersion): { spec+: { bootstrap+: { configRef+: { apiVersion: apiVersion } } } },
        ...
        withFieldPath(fieldPath): { spec+: { bootstrap+: { configRef+: { fieldPath: fieldPath } } } },
        ...
        withKind(kind): { spec+: { bootstrap+: { configRef+: { kind: kind } } } },
        ...
        withName(name): { spec+: { bootstrap+: { configRef+: { name: name } } } },
        ...
        withNamespace(namespace): { spec+: { bootstrap+: { configRef+: { namespace: namespace } } } },
        ...
        withResourceVersion(resourceVersion): { spec+: { bootstrap+: { configRef+: { resourceVersion: resourceVersion } } } },
        ...
        withUid(uid): { spec+: { bootstrap+: { configRef+: { uid: uid } } } },
      },
      ...
      withData(data): { spec+: { bootstrap+: { data: data } } },
      ...
      withDataSecretName(dataSecretName): { spec+: { bootstrap+: { dataSecretName: dataSecretName } } },
    },
    ...
    withNodeDrainTimeout(nodeDrainTimeout): { spec+: { nodeDrainTimeout: nodeDrainTimeout } },
