{
  ...
  '#':: d.pkg(name='machineHealthCheck', url='', help='"MachineHealthCheck is the Schema for the machinehealthchecks API."'),
  ...
  '#new':: d.fn(help='new returns an instance of MachineHealthCheck', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'cluster.x-k8s.io/v1beta1',
    kind: 'MachineHealthCheck',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"spec is the specification of machine health check policy"'),
  spec: {
    ...
    remediationTemplate: {
      ...
      withApiVersion(apiVersion): { spec+: { remediationTemplate+: { apiVersion: apiVersion } } },
      ...
      withFieldPath(fieldPath): { spec+: { remediationTemplate+: { fieldPath: fieldPath } } },
      ...
      withKind(kind): { spec+: { remediationTemplate+: { kind: kind } } },
      ...
      withName(name): { spec+: { remediationTemplate+: { name: name } } },
      ...
      withNamespace(namespace): { spec+: { remediationTemplate+: { namespace: namespace } } },
      ...
      withResourceVersion(resourceVersion): { spec+: { remediationTemplate+: { resourceVersion: resourceVersion } } },
      ...
      withUid(uid): { spec+: { remediationTemplate+: { uid: uid } } },
    },
    '#selector':: d.obj(help='"selector is a label selector to match machines whose health will be exercised"'),
    selector: {
    ...
    '#withMaxUnhealthy':: d.fn(help='"maxUnhealthy specifies the maximum number of unhealthy machines allowed.\\nAny further remediation is only allowed if at most \\"maxUnhealthy\\" machines selected by\\n\\"selector\\" are not healthy.\\n\\nDeprecated: This field is deprecated and is going to be removed in the next apiVersion. Please see https://github.com/kubernetes-sigs/cluster-api/issues/10722 for more details."', args=[d.arg(name='maxUnhealthy', type=d.T.any)]),
    withMaxUnhealthy(maxUnhealthy): { spec+: { maxUnhealthy: maxUnhealthy } },
    ...
    withNodeStartupTimeout(nodeStartupTimeout): { spec+: { nodeStartupTimeout: nodeStartupTimeout } },
    ...
    withUnhealthyConditions(unhealthyConditions): { spec+: { unhealthyConditions: if std.isArray(v=unhealthyConditions) then unhealthyConditions else [unhealthyConditions] } },
    ...
    withUnhealthyConditionsMixin(unhealthyConditions): { spec+: { unhealthyConditions+: if std.isArray(v=unhealthyConditions) then unhealthyConditions else [unhealthyConditions] } },
    '#withUnhealthyRange':: d.fn(help='"unhealthyRange specifies the range of unhealthy machines allowed.\\nAny further remediation is only allowed if the number of machines selected by \\"selector\\" as not healthy\\nis within the range of \\"unhealthyRange\\". Takes precedence over maxUnhealthy.\\nEg. \\"[3-5]\\" - This means that remediation will be allowed only when:\\n(a) there are at least 3 unhealthy machines (and)\\n(b) there are at most 5 unhealthy machines\\n\\nDeprecated: This field is deprecated and is going to be removed in the next apiVersion. Please see https://github.com/kubernetes-sigs/cluster-api/issues/10722 for more details."', args=[d.arg(name='unhealthyRange', type=d.T.string)]),
    withUnhealthyRange(unhealthyRange): { spec+: { unhealthyRange: unhealthyRange } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
